  ...
  return (
    <div className="space-y-8 pb-10">
      <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} className="glass-panel rounded-[32px] p-7">
        ...
        <h1 className="mt-3 font-display text-4xl font-semibold text-white">Generate a live stock trend prediction.</h1>
        <p className="mt-3 max-w-3xl text-sm leading-7 text-slate-400">
          Choose a symbol and sample index, then run the best trained model. The result is stored in prediction history automatically.
        </p>
